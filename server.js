...
const fs = require('fs');
const cors = require('cors'); // Added CORS for cross-origin frontend support

const app = express();
const PORT = process.env.PORT || 3000;

// Enable CORS so your frontend (e.g., Netlify/Vercel) can talk to Render
app.use(cors());
...
// 2. Fetch Route (Fixed to /api/content so your frontend matches)
